...
BEGIN_XTRA
	...
	BEGIN_XTRA_DEFINES_CLASS(CAsset, XTRA_CLASS_VERSION)
		...
		CLASS_DEFINES_INTERFACE(CSprite, IMoaNotificationClient, XTRA_CLASS_VERSION)	
		#endif
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
	BEGIN_XTRA_DEFINES_CLASS(CSprite, XTRA_CLASS_VERSION)
		CLASS_DEFINES_INTERFACE(CSprite, IMoaMmXSpriteActor, XTRA_CLASS_VERSION)
		/*
		 * --> insert additional interface(s)
		 */
	END_XTRA_DEFINES_CLASS
