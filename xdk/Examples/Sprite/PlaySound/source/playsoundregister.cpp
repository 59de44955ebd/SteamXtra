...
/* ---------------------------------------------------- MoaCreate_CRegister */
STDMETHODIMP MoaCreate_CPlaySoundRegister(CPlaySoundRegister * This)
{
...
STDMETHODIMP_(void) MoaDestroy_CPlaySoundRegister(CPlaySoundRegister * This)
{
	return;
}

/* ---------------------------------- CRegister_IMoaRegister Create/Destroy */
CPlaySoundRegister_IMoaRegister::CPlaySoundRegister_IMoaRegister(MoaError * pErr)
	{ *pErr = (kMoaErr_NoErr); }
