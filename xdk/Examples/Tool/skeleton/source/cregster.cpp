 ...
 *     CTool		   <name of class for the Tool xtra>
 *
...
STDMETHODIMP CRegister_IMoaRegister::Register(PIMoaCache pCache, PIMoaXtraEntryDict pXtraDict)
{
	...
	{
		if ((err = pCache->AddRegistryEntry(pXtraDict, &CLSID_CTool, &IID_IMoaMmXTool, &pRegDict)) != kMoaErr_NoErr) 
			break;
