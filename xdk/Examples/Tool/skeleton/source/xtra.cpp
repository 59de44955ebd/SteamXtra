 ...
 *****************************************************************************/ 
 BEGIN_XTRA
	...
	END_XTRA_DEFINES_CLASS
 	BEGIN_XTRA_DEFINES_CLASS(CTool, XTRA_CLASS_VERSION)
 		CLASS_DEFINES_INTERFACE(CTool, IMoaMmXTool, XTRA_CLASS_VERSION)
		#ifdef USING_INIT_FROM_DICT
 		CLASS_DEFINES_INTERFACE(CTool, IMoaInitFromDict, XTRA_CLASS_VERSION)
		#endif
		#ifdef USING_NOTIFICATION_CLIENT
		CLASS_DEFINES_INTERFACE(CTool, IMoaNotificationClient, XTRA_CLASS_VERSION)	
		#endif
 		/*
		 * ---> insert additional interface(s) -->
		 */ 
