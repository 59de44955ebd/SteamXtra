 ...
 *  5. For Macintosh XCode, edit both the xcconfig files and
 *     Replace         With	
 *     -------         ----
 *     CTool           <name to be used for the Xtra file>
 ...
 *	GUID, use the uuidgen command (Mac) or the GUIDGEN.EXE utility (Win).
 *	The following line will produce a pre-compiler error if not replaced with
 *	a valid CLSID.
 ****************************************************************************/ 
#error PLEASE DEFINE A NEW CLSID	
//DEFINE_GUID(CLSID(CTool), 0x00000000L, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
