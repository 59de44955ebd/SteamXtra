...
/* ---------------------------------------------------- MoaCreate_CRegister */
STDMETHODIMP MoaCreate_CTallWideRegister(CTallWideRegister * This)
{
	X_ENTER
...
STDMETHODIMP_(void) MoaDestroy_CTallWideRegister(CTallWideRegister * This)
{
}

/* ---------------------------------- CRegister_IMoaRegister Create/Destroy */
CTallWideRegister_IMoaRegister::CTallWideRegister_IMoaRegister(MoaError * pErr)
	{ *pErr = (kMoaErr_NoErr); }
